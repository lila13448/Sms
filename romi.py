...
def update():
    ...
    try:
        parsedData = requests.get("https://raw.githubusercontent.com/romi-Noob/romiBomber/main/more/.version").json()
    except:
    ...
    if (toolVersion != mainVersion):
        ...
        os.system("cd .. && rm -rf romiBomber && git clone https://github.com/romi-Noob/romiBomber > /dev/null 2>&1")
        
        print("\033[37mDone")
        psb("\n    \033[92m[\033[37m*\033[92m] \033[37mStarting Tool...")
        time.sleep(0.8)
        
        os.system("cd .. && cd romiBomber && python Tbomb.py")
...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : romi Inc.                \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/romi-Noob \033[94m│".center(columns+9))
...
def check(sent):
    ...
    if (sent == amount):
        ...
        psb("\033[92m    [\033[37m*\033[92m] From   : \033[37mromiBomber\n")
        time.sleep(0.6)
